/**
 * Data Service Layer (Clean Single Repository Root Architecture)
...
/**
 * Fetch `data/today.json` from repository data folder
 */
async function fetchLiveTodayJson() {
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log("Successfully loaded data/today.json generated by GitHub Actions!");
      return liveDataCache;
    }
  } catch (e) {
    console.warn("`data/today.json` not available or running offline, using mockData fallback:", e);
  }
  return null;
}
